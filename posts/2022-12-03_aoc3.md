...
Nothing much to say here. 70% of the time comparing characters, which is
the core of what we want to do, anyway, and not much extra memory
...
[^1]: Assuming lookup is O(1)... approximately. Of course, it's more
    ...
    more like O(n^2) (maybe O(nlog n) using unsorted trees). I bet all
